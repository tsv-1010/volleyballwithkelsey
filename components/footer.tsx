...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden bg-slate-900 py-16 px-6 text-slate-300">
      {/* Background effect */}
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-orange-400">with Kelsey</p>
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-6">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-lg bg-slate-800 transition-colors hover:bg-orange-500"
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 gap-2">
              {serviceAreas.map((area, index) => (
                <li key={index} className="flex items-center gap-1.5 text-sm text-slate-400">
          ...
          <div>
            ...
            <div className="mt-6 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
              <p className="text-xs text-slate-400">
                <span className="text-orange-400 font-semibold">Quick Tip:</span> The fastest 
